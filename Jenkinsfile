   ...
   stages {
        ...
        stage("Run test") {
            steps {
                ...
                sh '''docker run --rm -v /home/unixuser/.m2/repository:/root/.m2/repository
                -v web-allure:/home/unixuser/web_tests/allure-results
                -e URL=$url -e BROWSER=$browser playwright-tests'''
            }
       }
       stage("Allure report") {
            steps {
